            ...
            <img src={user.namafile} alt="Avatar" style={{width:"100%"}}/>
                <div class="w3-container w3-center">
                    ...
                    <div class="w3-section">
                        <a href={user.instagram} class="w3-button w3-grey" style={{borderRadius: '50px'}}><i class="fa fa-instagram" aria-hidden="true"></i></a>
                        <a href={user.linkedin} class="w3-button w3-grey" style={{borderRadius: '50px'}}><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                    </div>
                </div>
