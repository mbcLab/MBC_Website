...
const Project = () => {
    ...
    return(
      ...
      <header class="w3-container w3-center" style={{paddingTop: '100px',height:"300px",borderEndEndRadius:"100px",borderEndStartRadius:"100px", background:"#02073E"}}>
        ...
        <div class="w3-container w3-padding w3-center" style={{height:"1000px"}}>
        ...
        {projects.map((project, index) => (
                    <div class="w3-col s3 w3-card" style={{ padding:"30px",margin:"50px", borderRadius: '50px',background:"#02073E"}}>
                            <div class="w3-container w3-center">
                                <img src={project.namafile} alt="Avatar" style={{marginTop:"50px",maxWidth:"200px"}}/>
                                    <h5 class="w3-text-white">{project.proyek}</h5>
                                    <h5 class="w3-text-white">sampai tanggal {project.tanggalberakhir}</h5>
                                <div class="w3-section">
                                    <a href={`/Projek/${project._id}`} class="w3-button w3-grey" style={{borderRadius: '50px'}}>lihat</a>
                                </div>
                            </div>
                        </div>
                    ))}
