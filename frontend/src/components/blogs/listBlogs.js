    ...
    <section class="w3-container">
        ...
        <div class="w3-col s3 w3-card" style={{ padding:"30px",margin:"50px", borderRadius: '50px',background:"#02073E"}}>
                <div class="w3-container w3-center">
                    <img src={berita.namafile} alt="Avatar" style={{marginTop:"50px",maxWidth:"200px"}}/>
                        <h5 class="w3-text-white">{berita.judul}</h5>
                    <div class="w3-section">
                        <a href={`/Blog/${berita._id}`} class="w3-button w3-grey" style={{borderRadius: '50px'}}>lihat</a>
                    </div>
                </div>
            </div>
        ))}
